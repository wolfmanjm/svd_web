...
CREATE TABLE peripherals (id SERIAL PRIMARY KEY, mpu_id integer REFERENCES mpus NOT NULL, derived_from_id integer, name text NOT NULL UNIQUE, base_address text NOT NULL, description text);
